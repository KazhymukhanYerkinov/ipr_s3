...
mixin _$FilesState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(List<SecureFileEntity> files, String searchQuery,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(List<SecureFileEntity> files, String searchQuery,
            SortStrategy? sortStrategy)?
        loaded,
...
class _$FilesLoadedImpl implements FilesLoaded {
  ...
  int get hashCode => Object.hash(runtimeType,
      const DeepCollectionEquality().hash(_files), searchQuery, sortStrategy);
