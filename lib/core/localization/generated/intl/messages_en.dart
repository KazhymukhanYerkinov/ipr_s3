...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m0(fileName) => "This will permanently delete \"${fileName}\".";

  static String m1(folderName) =>
      "This will permanently delete \"${folderName}\" and all subfolders.";

  static String m2(fileName) => "Encrypting ${fileName}...";

  static String m3(fileName) => "\"${fileName}\" deleted";

  static String m4(completed, total) => "${completed} of ${total} files";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "createFourDigitCode": MessageLookupByLibrary.simpleMessage(
    ...
    "deleteFileContent": m0,
    "deleteFileTitle": MessageLookupByLibrary.simpleMessage("Delete file?"),
    "deleteFolderContent": m1,
    "deleteFolderTitle": MessageLookupByLibrary.simpleMessage("Delete folder?"),
    "device": MessageLookupByLibrary.simpleMessage("Device"),
    "encryptingFile": m2,
    "enterPin": MessageLookupByLibrary.simpleMessage("Enter PIN"),
    "enterPinAgain": MessageLookupByLibrary.simpleMessage("Enter PIN again"),
    "fileDeleted": m3,
    ...
    "importingFiles": MessageLookupByLibrary.simpleMessage("Importing Files"),
