...
import 'package:ipr_s3/features/files/data/sources/files_local_source.dart'
    as _i943;
import 'package:ipr_s3/features/files/data/sources/files_local_source_impl.dart'
    as _i332;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i174.GetIt init({
    ...
    gh.lazySingleton<_i879.FilesService>(() => _i879.FilesService(
    ...
    gh.lazySingleton<_i191.FoldersService>(() => _i191.FoldersService(
          gh<_i57.FoldersLocalSource>(),
          gh<_i943.FilesLocalSource>(),
        ));
    gh.factory<_i152.GetFoldersBehavior>(
        () => foldersModule.getFoldersBehavior(gh<_i191.FoldersService>()));
    gh.factory<_i19.CreateFolderBehavior>(
        () => foldersModule.createFolderBehavior(gh<_i191.FoldersService>()));
    ...
    gh.factory<_i188.AuthSignInWithGoogleUseCase>(() =>
